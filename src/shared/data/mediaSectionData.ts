...
export const TOOL_OPTIONS = [
  {
    ...
    image:ecoImg,
    options: [
      { text: "Без бачка и регулировки подачи абразива(1 разгонная трубка в комплекте)", price: {RU:5000, BY:75} },
      { text: "Без бачка, но с регулировкой подачи абразива(1 разгонная трубка в комплекте)", price:{RU:5000, BY:90}},
      { text: "С бачком(2 разгонных трубки в комплекте)", price: {RU:5000, BY:140} },
    ],
  },
  {
    toolName:'Классик',
    ...
    image:classicImage,
    options: [
      { text: "Без бачка и регулировки подачи абразива(1 разгонная трубка в комплекте)", price: {RU:5000, BY:85} },
      { text: "Без бачка, но с регулировкой подачи абразива(1 разгонная трубка в комплекте)", price: {RU:5000, BY:100} },
  ...
  },
  {
    ...
    image:titanImg,
    options: [
      { text: "Без бачка и регулировки подачи абразива(1 разгонная трубка в комплекте)", price: {RU:5000, BY:100} },
      { text: "Без бачка, но с регулировкой подачи абразива(1 разгонная трубка в комплекте)", price: {RU:5000, BY:115} },
      { text: "С бачком(2 разгонных трубки в комплекте)", price: {RU:5000, BY:165} },
    ],
  }
];
